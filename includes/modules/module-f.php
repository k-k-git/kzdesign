...
if ( ! $barcelona_async ) {
	...
	echo '<div id="fix-f" class="posts-box posts-box-5'. ( is_single() ? ' posts-box-related-posts' : '' ) .'"'. $barcelona_attr_str .'>';
...
switch ( $barcelona_col_number ) {
	...
	case 5:
		...
		break;
	case 6:
		$barcelona_col_cls = 'col-lg-2 col-md-4 col-sm-6 col-xs-6';
		break;
	default:
